<?php
    ...
    $TEXT['Page_Footer'] = "All rights reserved &copy; 2011 - 2013 Polytech'Montpellier";

    $TEXT['Page_Error404'] = "Error 404";
    $TEXT['Page_Error403'] = "Error 403";
    ...
    $TEXT['Title_LectureIndex'] = "Lectures";
    ...
    $TEXT['Flash_SubscribeVisitor'] = 'Your cannot subscribe to a package because you are a visitor.';
    $TEXT['Flash_SubscribeGenerated'] = 'You cannot subscribe to a package because your MCQ is already generated.';
    $TEXT['Flash_SubscribeTaken'] = 'You cannot subscribe to a package because you have already taken your MCQ.';
    $TEXT['Flash_SubscribeConflict'] = 'There is a conflict with the lectures you subscribed to.';
    $TEXT['Flash_SubscribeImpossible'] = "Subscription impossible.";
    ...
    $TEXT['Flash_NoPackage'] = "There is no available package.";
    $TEXT['Flash_UploadError'] = "Error during the upload.";
    ...
    $TEXT['Package_NoSubscribtion'] = "You have no subscription.";
    ...
    $TEXT['Planning_NoRegistrations'] = "No available registration";
